...
- [x] T081 [P] [US5] 驗證 AI 決策邏輯在 OpponentAI 服務
- [x] T082 [P] [US5] 確保本地事件匯流排效能 < 10ms 延遲
- [x] T083 [US5] 實作本地遊戲狀態持久化（可選）在 LocalGameRepository
- [x] T084 [US5] 優化記憶體使用和垃圾回收
- [x] T085 [US5] 確保無網路依賴的完整遊戲體驗
