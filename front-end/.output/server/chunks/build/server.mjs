...
const _routes = [
  {
    name: "game",
    path: "/game",
    meta: { "middleware": "game" },
    component: () => import('./game-Dgs9wsIV.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CDwphgWJ.mjs')
  },
  {
    name: "lobby",
    path: "/lobby",
    meta: { "middleware": "lobby" },
    component: () => import('./lobby-B23QeIdE.mjs')
  }
];
...
const namedMiddleware = {
  game: () => import('./game-CQzQAZN8.mjs'),
  lobby: () => import('./lobby-EgOq-Mhi.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B73Ai5bp.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DOf5AbYu.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, defineNuxtRouteMiddleware as d, entry$1 as default, navigateTo as n, resolveRouteObject as r, useRouter as u };
