...
import type { PlayerStatsRepositoryPort, UpsertPlayerStatsInput } from '~~/server/core-game/application/ports/output/playerStatsRepositoryPort'
import {
  RecordGameStatsError,
  type RecordGameStatsInputPort,
  type RecordGameStatsInput,
  type RecordGameStatsOutput,
} from '~~/server/core-game/application/ports/input/recordGameStatsInputPort'

// Re-export for backwards compatibility
export { RecordGameStatsError } from '~~/server/core-game/application/ports/input/recordGameStatsInputPort'
