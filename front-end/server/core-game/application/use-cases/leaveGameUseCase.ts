...
} from '~~/server/core-game/application/ports/input/leaveGameInputPort'

// Re-export for backwards compatibility
export { LeaveGameError } from '~~/server/core-game/application/ports/input/leaveGameInputPort'
export type { LeaveGameEventMapperPort } from '~~/server/core-game/application/ports/output/eventMapperPort'
