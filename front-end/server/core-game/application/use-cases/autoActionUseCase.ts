...
import type { Game as _Game } from '~~/server/core-game/domain/game/game'
import { getPlayerHand } from '~~/server/core-game/domain/round'
import {
  HIKARI_CARDS,
  TANE_CARDS,
  TANZAKU_CARDS,
...
import type {
  AutoActionInputPort,
  AutoActionInput,
} from '~~/server/core-game/application/ports/input/autoActionInputPort'
