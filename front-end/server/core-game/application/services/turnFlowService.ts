...
import { type Game, finishGame, endRound } from '~~/server/core-game/domain/game/game'
import { isLastRound } from '~~/server/core-game/domain/game/gameQueries'
import type { SpecialRuleResult } from '~~/server/core-game/domain/services/specialRulesService'
import type { RoundEndReason } from '#shared/contracts'
import { calculateWinner } from '~~/server/core-game/domain/game/gameEndConditions'
...
import type { RoundEndResult } from '~~/server/core-game/domain/round'
import {
