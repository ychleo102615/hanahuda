 ...
 * 並在測試時輕鬆 Mock。
 *
 * Domain Layer 位於: src/game-client/domain/
 *
 * @example
 * ```typescript
 * // 生產環境實作
 * import * as domain from '~/game-client/domain'
 *
...
import type { Card, CardType, YakuType, YakuProgress, ValidationResult } from '~/game-client/domain'
