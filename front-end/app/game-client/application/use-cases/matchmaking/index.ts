 ...
 *
 * @module app/game-client/application/use-cases/matchmaking
 */
...
export { HandleRoomDissolvedUseCase } from './HandleRoomDissolvedUseCase'
export { HandleRoomExpiringUseCase } from './HandleRoomExpiringUseCase'
