...
<template>
  ...
  >
    ...
    >
      ...
      <!-- animate-hero-cta 放在 wrapper 而非 button，讓 scale 動畫同時帶動光線 spans -->
      <GoldRayWrapper
        inline
        :enabled="!isNavigating"
        :class="!isNavigating && 'animate-hero-cta hover:[animation-play-state:paused]'"
      >
        <button
          ...
          :class="[
            'inline-flex items-center rounded-lg bg-lacquer-black/80 border border-gold-light text-gold-light px-8 py-4 text-lg font-semibold transition-all duration-300 cursor-pointer',
