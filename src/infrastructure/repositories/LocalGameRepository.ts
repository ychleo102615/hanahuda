import type { Card, CardType } from '@/features/game-engine/domain/entities/Card'
import { CardEntity } from '@/features/game-engine/domain/entities/Card'
import { Player } from '@/features/game-engine/domain/entities/Player'
import type { GameState, GameMove } from '@/features/game-engine/domain/entities/GameState'
import { GameState as GameStateClass } from '@/features/game-engine/domain/entities/GameState'
import { Yaku } from '@/features/game-engine/domain/entities/Yaku'
import type { YakuResult } from '@/features/game-engine/domain/entities/Yaku'
import type { GameRepository, PlayCardRequest, PlayCardResult } from '@/features/game-engine/application/ports/repositories/GameRepository'
