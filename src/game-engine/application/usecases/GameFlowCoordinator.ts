...
import type { GameState as AppGameState, RoundResult as AppRoundResult } from '@/domain/entities/GameState'
import type { Player as AppPlayer } from '@/domain/entities/Player'
